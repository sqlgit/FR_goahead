...
cJSON *single_json_construction(char **resultp, int nrow, int ncloumn); //查询的数据转换成单个 object 的cJSON格式
...
int select_info_json_sqlite3_single(char *db_name, const char *sql, cJSON **JSON_Data); //获取数据库中某一行的数据内容，以单个 object 形式返回

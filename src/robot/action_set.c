...
void set(Webs *wp)
{
	...
	// cmd_auth "2"
	} else if (cmd == 101 || cmd == 102 || cmd == 103 || cmd == 104 || cmd == 105 || cmd == 106 || cmd == 107 || cmd == 227 || cmd == 229 || cmd == 301 || cmd == 303 || cmd == 316 || cmd == 321 || cmd == 330 || cmd == 333 || cmd == 338 || cmd == 345 || cmd == 375 || cmd == 400 || cmd == 401 || cmd == 402 || cmd == 405 || cmd == 412 || cmd == 413 || cmd == 414 || cmd == 423 || cmd == 424 || cmd == 429 || cmd == 527 || cmd == 1001 || cmd == 572) {
	...
	case 571:
		port = cmdport;
		strcpy(log_content, "设置外设协议");
		strcpy(en_log_content, "Set the peripheral protocol");
		strcpy(jap_log_content, "周辺機器協議を設置する");
		ret = copy_content(data_json, content);
		break;
	case 572:
		port = cmdport;
		strcpy(log_content, "获取外设协议");
		strcpy(en_log_content, "Get the peripheral protocol");
		strcpy(jap_log_content, "周辺機器協議の獲得");
		ret = copy_content(data_json, content);
		break;
	case 1001:/* 内部定义指令 */
		port = cmdport;
